...
class _MachineListState extends State<MachineList> {
  ...
  void FetchMachinesMachineList() async {
    ...
    final response = await http.get(
      Uri.parse('${Constants.weblink}MachineGetListingData'),
  ...
  void AddMachinesMachineList() async {
    final response = await http.post(
      Uri.parse('${Constants.weblink}MainMachineAdd'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $tokenvalue',
      },
  ...
  void UpdateMachinesMachineList(String id) async {
    print(tokenvalue);
    final response = await http.post(
      Uri.parse('${Constants.weblink}MachineUpdate/$id'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $tokenvalue',
      },
  ...
  void deleteMachine(int id) async {
    final response = await http.post(
      Uri.parse('${Constants.weblink}MainMachineDelete/$id'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $tokenvalue',
      },
