...
class _SubMachineState extends State<SubMachine> {
  ...
  void FetchSubMachineList() async {
    ...
    final response = await http.get(
      Uri.parse('${Constants.weblink}MachineSubGetListingData'),
  ...
  void AddSubMachine() async {
    final response = await http.post(
      Uri.parse('${Constants.weblink}MachineSubAdd'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $tokenvalue',
      },
  ...
  void UpdateMachinesMachineList(String id) async {
    print(tokenvalue);
    final response = await http.post(
      Uri.parse('${Constants.weblink}MachineSubUpdate/$id'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $tokenvalue',
      },
  ...
  void deleteMachine(String id) async {
    final response = await http.post(
      Uri.parse('${Constants.weblink}MachineSubAddDelete/$id'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $tokenvalue',
      },
                    ...
                    child: Scaffold(
                      body: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return (widget.id ==
                                  data[index]['categories_id'].toString())
                              ? Padding(
